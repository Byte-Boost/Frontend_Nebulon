...
const NewSidebarItem = ({text, height = 'h-16', iconDimensions = '50'}) => {
    return(
            <Card className={height} style={{ border: "1px solid [#D2D2D2]" }}>
                <div className="flex flex-row">
                    <div className="m-2">
                        <svg xmlns="http://www.w3.org/2000/svg" height={iconDimensions} viewBox="0 0 24 24" width={iconDimensions}>
