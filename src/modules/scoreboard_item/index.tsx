...
const ScoreboardItem = (props: scoreboardItemProps) => {
  ...
  return (
      <div className="rounded-full flex justify-between gap-4 p-4 shadow-md bg-gray-100">
        ...
        <div className="h-full grow flex flex-col">
          ...
          <h6 className="text-sm ml-4">{props.people} {props.people>1?"pessoas":"pessoa"} aqui</h6>
        </div>
